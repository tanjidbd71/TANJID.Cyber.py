...
CorrectUsername = "TANJID"

CorrectPassword = "TANJID.VAI"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://youtube.com/channel/UCK0ZnHpV7bQnOwuHwjk2Ehw')
...
def login():
	...
	try:
		...
		try:
			...
			br.open('https://www.facebook.com/please.kolixa.report.my.id')
		...
		if 'save-device' in url:
			...
			try:
				...
				url = "https://www.facebook.com/please.kolixa.report.my.id"
